...
function DarkMapScreen(props) {
	...
	return (
		<SafeAreaView style={(styles.container, { flex: 1 })}>
            ...
            // Ended up using Base64 encoded images, this prevents the assets from
            // being moved up to the cloud since they're now a string and technically
            // not an image, this is a complete hack but it works.
            // https://github.com/react-native-maps/react-native-maps/issues/2997
						let pinType = '';
